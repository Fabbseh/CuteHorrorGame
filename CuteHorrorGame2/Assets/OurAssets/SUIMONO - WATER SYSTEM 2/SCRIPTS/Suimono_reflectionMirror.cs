...
public class Suimono_reflectionMirror : MonoBehaviour
{
    public bool m_DisablePixelLights = true;
    public int m_TextureSize = 256;
    public float m_ClipPlaneOffset = 0.07f;
	public float m_ReflectionDistance = 200.0f;
	...
	public bool m_hasRendered = false;
	public bool m_doRender = true;
    ...
    public void SetLayerMask(int getLayers){
        setLayers = getLayers;
    }

    public void SetReflectResolution(int getRes){
        m_TextureSize = getRes;
    }
	...
	public void OnWillRenderObject()
    {
		...
		//if (Vector3.Distance (this.transform.position, cam.transform.position) > m_ReflectionDistance) {
		//	if (m_hasRendered = true) m_doRender = false;
		//} else {
		//	m_doRender = true;
		//}
        ...
        reflectionCamera.cullingMask = setLayers;
        ...
        //}
 		//this.transform.parent.transform.renderer.material.SetMatrix( "_ProjMatrix", mtx );
		//this.transform.parent.gameObject.Find(Suimono_Object).renderer.material.SetMatrix( "_ProjMatrix", mtx );
    ...
    private void UpdateCameraModes( Camera src, Camera dest )
    {
		...
		dest.farClipPlane = src.farClipPlane;//*2.0f;
    ...
    private Vector4 CameraSpacePlane (Camera cam, Vector3 pos, Vector3 normal, float sideSign)
    {
        ...
        //Vector3 offsetPos = pos + normal * (m_ClipPlaneOffset - (cam.transform.position.y * 1.0f));
